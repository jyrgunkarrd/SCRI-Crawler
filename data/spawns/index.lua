...
local function addDefinitions(category_path, module_name)
    ...
    local category = spawn_index.categorized
    ...
    for _, definition in ipairs(definitions) do
        if definition.id then
            ...
            spawn_index.byId[definition.id] = definition
            spawn_index.all[#spawn_index.all + 1] = definition
        end
    end
end
